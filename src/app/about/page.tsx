...
export default function AboutPage() {
  return (
    <div className="pt-20">
          ...
          <div className="lg:col-span-8 bg-surface border border-line p-12 rounded flex flex-col justify-between shadow-2xl relative">
            ...
            <div className="space-y-6">
              ...
              <p className="text-paper-dim text-sm leading-relaxed">
                At Uranus, we don't just supply materials; we engineer certainty. Over the years, our operations have evolved to incorporateMetso-VSI plant technology, high-efficiency crushing zone lines, and a massive supply chain fleet capable of dispatching aggregates daily. We ensure that every batch of aggregate and sand complies with modern national standards while minimizing environmental impacts.
              </p>
            </div>
      ...
      <section className="py-20 bg-surface-2 border-y border-line">
